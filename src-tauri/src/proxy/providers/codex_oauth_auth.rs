...
impl CodexOAuthManager {
    ...
    pub async fn start_device_flow(&self) -> Result<GitHubDeviceCodeResponse, CodexOAuthError> {
        self.start_device_flow_with_proxy_and_target(None, None)
            .await
    }
    ...
    pub async fn start_device_flow_with_proxy(
        ...
        self.start_device_flow_with_proxy_and_target(None, provider_upstream_proxy_url)
            .await
    }

    pub async fn start_device_flow_with_proxy_and_target(
        &self,
    ...
    {
        self.poll_for_token_with_proxy_and_guard(device_code, None, before_commit)
            .await
    }
    ...
    pub async fn poll_for_token_with_proxy(
        ...
        self.poll_for_token_with_proxy_and_guard(
            device_code,
    ...
    pub async fn poll_for_token_with_proxy_and_guard<BeforeCommit, CommitFuture, CommitGuard>(
        &self,
        device_code: &str,
        provider_upstream_proxy_url: Option<&str>,
        before_commit: BeforeCommit,
